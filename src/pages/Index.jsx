...
export default function Index() {
  ...
  return (
    <>
      <Helmet>
        <title>IntegraObra | Soluciones para la Construcción.</title>
        ...
        {/* Open Graph */}
        <meta property="og:title" content="IntegraObra | Soluciones para la Construcción." />
        ...
        <meta name="twitter:title" content="IntegraObra | Soluciones para la Construcción." />
