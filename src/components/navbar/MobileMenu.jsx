    ...
    <div className='lg:hidden bg-[#53545B] shadow-lg'>
      <div className='flex flex-col px-4 py-4 space-y-2'>
        ...
        <details className='group'>
          ...
          <div className='pl-4 mt-2 space-y-2'>
            <a href='/servicios/areas-verdes' className='block text-blue-100 py-2 px-4 hover:bg-[#0578b8] rounded' onClick={() => setIsMenuOpen(false)}>Mantenimiento de áreas verdes</a>
            <a href='/servicios/instalacion-manto-climas' className='block text-blue-100 py-2 px-4 hover:bg-[#0578b8] rounded' onClick={() => setIsMenuOpen(false)}>Instalación de manto y climas</a>
            <a href='/servicios/tablaroca-empastado' className='block text-blue-100 py-2 px-4 hover:bg-[#0578b8] rounded' onClick={() => setIsMenuOpen(false)}>Tablaroca y empastado</a>
            <a href='/servicios/electricidad' className='block text-blue-100 py-2 px-4 hover:bg-[#0578b8] rounded' onClick={() => setIsMenuOpen(false)}>Electricidad</a>
            <a href='/servicios/soldadura' className='block text-blue-100 py-2 px-4 hover:bg-[#0578b8] rounded' onClick={() => setIsMenuOpen(false)}>Soldadura</a>
            <a href='/servicios/cableado-estructurado' className='block text-blue-100 py-2 px-4 hover:bg-[#0578b8] rounded' onClick={() => setIsMenuOpen(false)}>Cableado estructurado</a>
          </div>
        </details>
