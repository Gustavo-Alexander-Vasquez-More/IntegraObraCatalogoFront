...
const servicios = [
  {
    ...
    descripcion: "Ofrecemos un amplio surtido de herramienta ligera para construcción y diversos oficios. Todos nuestros equipos son revisados y probados antes de cada entrega, garantizando un funcionamiento eficiente, seguro y de alta calidad en cada uno de sus proyectos.",
    icono: (
      <svg className='w-16 h-16' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
        <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z' />
      </svg>
    ),
    link: "/equipos/renta-equipos",
  ...
  },
  {
    ...
    descripcion: "Contamos con un taller especializado en equipos eléctricos y de combustión. Brindamos mantenimiento preventivo y correctivo con diagnósticos precisos, procesos transparentes y un firme compromiso con la honestidad para prolongar la vida útil de su maquinaria.",
    icono: (
      <svg className='w-16 h-16' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
  ...
  },
  {
    id: 3,
    titulo: "Refacciones",
    descripcion: "Disponemos de un inventario completo de refacciones originales para maquinaria de combustión y eléctrica. Garantizamos soluciones inmediatas para sus reparaciones y ofrecemos envíos rápidos a toda la República Mexicana para que su equipo nunca se detenga.",
    icono: (
      <svg className='w-16 h-16' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
  ...
  },
  {
    id: 4,
    titulo: "Construcción",
    descripcion: "Realizamos la ejecución integral de obras, desde el análisis de planos y planeación hasta la entrega final. Utilizamos materiales de la mejor calidad y mano de obra calificada para asegurar la durabilidad, estética y valor de su inversión inmobiliaria.",
    icono: (
      <svg className='w-16 h-16' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
        ...
        <div className='grid md:grid-cols-3 gap-8 max-w-7xl mx-auto'>
          {servicios.map((servicio, idx) => (
            servicio.id === 4 ? (
              <div
                key={servicio.id}
                className={`group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 ${servicios.length === 4 ? 'md:col-start-2' : ''}`}
              >
