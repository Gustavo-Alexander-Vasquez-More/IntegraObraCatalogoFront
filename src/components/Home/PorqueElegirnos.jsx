...
export default function PorqueElegirnos() {
  const razones = [
    ...
    },
    {
      id: 2,
      titulo: "Experiencia",
      descripcion: "Poseemos los conocimientos necesarios para ofrecer servicios integrales en las diferentes áreas de nuestro ramo.",
      icono: (
        <svg className='w-12 h-12' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
    ...
    },
    {
      id: 3,
      titulo: "Reputación",
      descripcion: "Nos distinguimos por actuar con integridad. Nuestra reputación se ha construido a través del trabajo bien hecho, una atención responsable y soluciones confiables que respaldan cada proyecto.",
      icono: (
        <svg className='w-12 h-12' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
